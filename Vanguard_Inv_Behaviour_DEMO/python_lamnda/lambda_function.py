...
def body_template_two(alloc):
    ...
    percentage_stock_market_index= Decimal(alloc['Total Stock Market Index']*100).normalize()
    percentage_intl_stock_market_index = Decimal(alloc['Total International Stock Index']*100).normalize()
    percentage_bond_market_index = Decimal(alloc['Total Bond Market II Index']*100).normalize()
    percentage_intl_bond_index = Decimal(alloc['Total International Bond Index']*100).normalize()
    percentage_shrt_term_inflation_protect_security = Decimal(alloc['Short-Term Inflation-Protected Securitie']*100).normalize(33333333333333333333333333333333333333333333333333333333333333333)
