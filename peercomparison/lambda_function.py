...
def Step_seven_sign_up(intent, session):
    ...
    speech_output = "Sure, ..., Done! By the way, from your social network profile, I noticed that you just had a baby. Is that correct ? "

    reprompt_text = "Sure, ..., Done! By the way, from your social network profile, I noticed that you just had a baby. Is that correct ? "
    should_end_session = False
...
def Step_eight_new_baby(intent, session):
    ...
    speech_output = "Congratulations! This is a great time to talk to a advisor about your financial plan. From our records, I see you have talked to our advisor Mike" \
                    "Albano before, and he is available to talk to you. Would you like to have a video conference with him now? "

    reprompt_text = "Congratulations! This is a great time to talk to a advisor about your financial plan. From our records, I see you have talked to our advisor Mike" \
                    "Albano before, and he is available to talk to you. Would you like to have a video conference with him now? "
